...
class NewSuccessPayment extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->subject('Pembayaran Berhasil ' . $this->method)
                    ->greeting('Hai ' . $this->order['customer']['name'] . ',')
                    ->line('Pembayaran dengan ' . $this->method . ' berhasil! Pesanan kamu telah diteruskan ke penjual')
                    ->action('Detail Pembayaran', url('/notifications/pembelian'));
    }
