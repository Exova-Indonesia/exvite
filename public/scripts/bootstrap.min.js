                            ...
                            modifiers: [
                                {
                                    ...
                                    options: {
                                        altBoundary: !0,
                                        fallbackPlacements: this.config
                                            .fallbackPlacements,
                                    },
                                },
                                {
    ...
    return (function (e) {
            ...
            var w = (function () {
                function e(t) {
                    ...
                    (this._handlers = {
                        ...
                        (this.boundPopStateHandler = this.popStateHandler.bind(
                            this
                        )),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.delegatedListeners.click.destroy(),
                                    ...
                                    (0, g.queryAll)("[data-swup]").forEach(
                                        function (e) {
            ...
            t.default = function (e, t) {
                ...
                this.triggerEvent("transitionStart", t),
                    ...
                    this.cache.exists(e.url)
                        ...
                        : (a =
                              this.preloadPromise &&
                              this.preloadPromise.route == e.url
                                  ? this.preloadPromise
                        ...
                        a = function (e) {
                            ...
                            (0, r.queryAll)(t[e]).forEach(function (i, a) {
                                (0, r.queryAll)(t[e], n)[a].setAttribute(
                                    ...
                                    o.push(
                                        (0, r.queryAll)(t[e], n)[a].outerHTML
                                    );
                            });
                        },
                        s = 0;
                        ...
                        r = function (r) {
                            null == e.querySelector(t[r])
                                ? console.warn(
                                      "Element " +
                                          t[r] +
                                          " is not in current page."
                                  )
                                : (0, i.queryAll)(t[r]).forEach(function (
                                      o,
                                      a
                                  ) {
                                      (0, i.queryAll)(t[r], e)[a].setAttribute(
                                          "data-swup",
                                          n
                                      ),
                                          n++;
                    ...
                    return (
                        i(e, [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var e =
                                        this.link.pathname + this.link.search;
                                    return (
                                        this.link.getAttribute("xlink:href") &&
                                            (e = this.link.getAttribute(
                                                "xlink:href"
                                            )),
                                        "/" !== e[0] && (e = "/" + e),
                                        e
        ...
        function (e, t, n) {
            ...
            t.default = function () {
                var e = [];
                return (
                    (0, i.queryAll)(this.options.animationSelector).forEach(
                        function (t) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                (t.use = function (e) {
                    if (e.isSwupPlugin)
                        return (
                            this.plugins.push(e),
                            (e.swup = this),
                            "function" == typeof e._beforeMount &&
                                e._beforeMount(),
                            e.mount(),
                            this.plugins
                        );
                ...
                (t.unuse = function (e) {
                    ...
                    if (
                        ...
                        t.unmount(),
                            "function" == typeof t._afterUnmount &&
                                t._afterUnmount();
        ...
        function (e, t, r) {
            ...
            var v = (function (e) {
                ...
                function t() {
                    ...
                    c(this, t);
                    for (
                        var a = arguments.length, u = Array(a), i = 0;
                        i < a;
                        i++
                    ) {
                        u[i] = arguments[i];
                        ...
                        (o =
                            ...
                            (n.onMouseover = function (e) {
                                ...
                                if (
                                    ...
                                    t.preloadPromise = t.preloadPage(
                                        r.getAddress()
                                    );
                            ...
                            (n.preloadPages = function () {
                                (0, l.queryAll)("[data-swup-preload]").forEach(
                                    function (e) {
            ...
            var o = function e(t, r) {
                ...
                var a = function e(a) {
                    if (t.querySelector(r[a]) == null) {
                        console.warn(
                            "Element " + r[a] + " is not in current page."
                        );
                    } else {
