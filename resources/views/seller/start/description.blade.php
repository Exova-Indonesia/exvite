   ...
   <div class="card-center px-3">
      ...
      <div class="col-lg-6 col-sm-12 mt-4 mx-auto">
        <div class="input-style input-style-always-active has-borders has-icon mb-4">    
                <input type="name" class="form-control" name="studio_description" id="slogan" placeholder="Exova Save The Culture">
        ...
        <div class="d-flex">
            <div class="mx-auto">
                <button type="button" class="btn btn-danger rounded-sm btn-l font-13 font-600 mt-5 border-0">Kembali</button>
