                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <a id="navbarDropdown" class="navbar-profile dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <img class="rounded-circle profile-picture" src="{{ Auth::user()->avatar->small }}" width="40" height="40" alt="avatar">
                                </a>
                                ...
                                <div class="dropdown-menu profile-drop dropdown-menu-right p-3" aria-labelledby="navbarDropdown">
                                    ...
                                    <div class="user-profile-picture">
                                        <img class="rounded-circle profile-picture" src="{{ Auth::user()->avatar->large }}" width="80" height="80" alt="avatar">
                                    </div>
